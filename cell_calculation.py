...
def get_unique_cells_in_drive(df):
    ...
    #     cells_locations = where_are_my_cells(cell) #TODO remove comments for cells visual
    #     if cells_locations.empty:
    #         print('oops')
    #     cell_dfs_list.append(cells_locations)
    # return_list = []
    # for drive in range(len(cell_dfs_list)):
    #     if len(cell_dfs_list[drive].dropna()) > 0: # TODO remove comments for cells visual
